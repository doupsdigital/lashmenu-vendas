...
/* ---------- Interceptador & Desabilitação de Botões no Modo Test Drive ---------- */
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (isTestDrive) {
    document.body.classList.add('is-testdrive');
  }
  ...
  document.addEventListener('click', (e) => {
    ...
    if (btn && (document.body.classList.contains('is-testdrive') || window.self !== window.top)) {
      e.preventDefault();
      e.stopPropagation();
      return false;
    }
