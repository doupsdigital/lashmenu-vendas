...
// ── Component ──────────────────────────────────────────────────────────────
export default function LandingPage_OfertaDois_Dark() {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-left" style={{ position: 'relative' }}>
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                ...
                <h3 style={{ fontSize: 15, fontWeight: 800, color: '#fca5a5', lineHeight: 1.3 }}>Sistemas Tradicionais</h3>
              </div>
              <motion.ul
                initial="hidden"
                whileInView="visible"
            ...
            >
              ...
              <div style={{ marginTop: 24, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                {['Sem WhatsApp pra agendar', 'Aviso instantâneo no celular', 'Disponível de madrugada'].map(t => (
                  <span key={t} style={{ fontSize: 11, color: P.accent, background: P.accentLight, border: `1px solid rgba(233,30,140,0.2)`, borderRadius: 999, padding: '4px 12px', fontWeight: 600 }}>{t}</span>
                ))}
              </div>
            </motion.div>
